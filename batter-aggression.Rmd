...
swing_data %>%
  ...
  ylim(0, 5) +
  xlim(-2, 2) +
  ggtitle("Free Swingers, 2022", subtitle = "Batters with the widest 'swing zones'") +
  labs(x = "Pitch Horizontal Location (ft)", y = "Pitch Height (ft)", caption = "Source: Baseball Savant through April 24, 2022. Min 28 swings")


ggsave("free-swingers.png", height = 8, width = 10)
...
swing_data %>%
  ...
  ylim(0, 5) +
  xlim(-2, 2) +
  ggtitle("Looking For Their Pitch, 2022", subtitle = "Batters with the smallest 'swing zones'") +
  labs(x = "Pitch Horizontal Location (ft)", y = "Pitch Height (ft)", caption = "Source: Baseball Savant through April 24, 2022. Min 28 swings")

ggsave("patient-swingers.png", height = 8, width = 10)
```
