...
Perez is the more aggressive hitter by far.
...
Seeing Votto at the top of the list validates that we're on the right track. There are other good hitter-seasons on there as well. The mean wRC+ of this group is a whopping 133. 
...
These hitter-seasons aren't so notable. The mean wRC+ of this group is just 91.
...
ggplot(plate_discipline_by_base_out_states, aes(x=runners_on_base, y=as.character(outs_when_up))) +
  ...
  ggtitle("Hitter Aggression by Base-Out State, 2015 - 2017") +
