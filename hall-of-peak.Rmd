...
graph_players <- function(max_seasons, num_peak_seasons, peak_threshold, war_threshold) {
  plt <-
    ...
    # filter for only one peak. this omits players who are uniformly excellent
    filter(n == 1) %>%
    ungroup() %>%
...
graph_players(12, 6, 0.83, 50) # only sandy koufax


graph_players(12, 6, 0.83, 40) # lower WAR threshold to 40

graph_players(15, 6, 0.83, 40) # increase season span to 15



graph_players(12, 3, 0.83, 25) # shorter peaks of 3 years. have to lower WAR threshold also
