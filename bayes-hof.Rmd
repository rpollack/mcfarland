...
prob_war_thru_age <- function(age, war, position){
  ...
  #have accumulated at least Y WAR at that position. only look at players who retired 5 years ago or earlier
...
albies_comparables <- war_through_age %>%
  filter(Position == "2B",
         Age <= 20,
         cumulative_war >= 1.9)
