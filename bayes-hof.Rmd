...
seasonal_war <- player_info %>%
  ...
  #jack morris and alan trammell got voted in on 12.10.2017. forcing HOF to Yes here until BB-Ref reflects this
  mutate(HOF = ifelse(Name %in% c("Jack Morris", "Alan Trammell"), "Yes", HOF))
                                                       ...
                                                       ifelse(Position == "C", 18,
                                                              ifelse(Position == "OF", 70,
                                                                     ifelse(Position == "DH", 0,
                                                                            ifelse(Position == "P", 78, hof_at_position)))))))),
...
bayes_hof <- inner_join(war_through_age, war_age_combinations, 
  ...
  dplyr::select(PlayerId, Name, Position, cumulative_war, Age, prob_hof, everything(), -WAR, 
                -HOF, -birth_year, -last_year, -p_hof_at_position) %>%
