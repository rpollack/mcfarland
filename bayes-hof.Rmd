...
bayes_hof <- inner_join(war_through_age, war_age_combinations, 
                                by=c("Age", "cumulative_war", "Position", "war_floor", "war_ceiling")) %>%
  ...
  dplyr::select(PlayerId, Name, prob_hof, Position, cumulative_war, Age, prob_hof, last_year, everything(), -WAR, 
