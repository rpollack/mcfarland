...
Features to try:
1. Supplement Lahman ASG and MVP point data with 2024 data from BBREF. 
...
# TODO: 2024 MVP data is not joining properly for some reason. totals are coming out to 0

# 
#   tibble(Season = 2024,
#          Player = c("Aaron Judge", "Bobby Witt Jr", "Juan Soto", "Gunnar Henderson", "Jose Ramirez", "Vladimir Guerrero Jr.," "Tarik Skubal", "Jarren Duran", "Yordan Alvarez", "Brent Rooker", "Emmanual Clase", "Cal Raleigh", "Rafael Devers", "Anthony Santander", "Jose Altuve", "Tyler Holton", "Seth Lugo", "Corey Seager", "Framber Valdez")) |>
#   mutate()
  
  # do the same for all star rosters
asg_supplement <-
    read_html("https://www.baseball-reference.com/allstar/2024-allstar-game.shtml")
```
...
bat_data_full <-
  ...
  # now that we have MVP point data from all time, no need to get actual awards
    # add in MVP data. this is to get to actual awards won & includes 2024 season. 
...
hof_split <-
  ...
  select(-PlayerId, -Name, -H, -HR, -SB, -off, -def, -mlb_played_last, -num_mvps, -num_asg, -num_seasons, -considered_hof, -WAR, -num_mvp_points, -cumulative_off, -cumulative_def) |>
