...
war_through_age <-
  ...
  dplyr::select(
    playerid = PlayerId, name = Name, mean_year, last_year, age = Age,
  ...
  dplyr::select(playerid, name, position = Position, last_year, mean_year, scandal_type, age, cumulative_war, considered_hof, hof) %>%
