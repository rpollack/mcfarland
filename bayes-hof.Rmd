...
#   )) %>%
  ...
  mutate(is_scandal = case_when(
    name %in% c("Barry Bonds", "Roger Clemens", "Joe Jackson", "Robinson Cano", "Pete Rose", "Alex Rodriguez", "Manny Ramirez", "Mark McGwire", "Sammy Sosa", "Jose Canseco", "Rafael Palmeiro", "Jason Giambi", "Gary Sheffield", "Miguel Tejada", "Nelson Cruz", "Andy Pettite", "Ryan Braun", "Carlos Beltran") ~ 1,
    TRUE ~ 0
  )) %>%
...
# plot the precision-recall curve. kinda matches the AUPRC which is a measly 0.58
# want to do better!!!
hof_results %>%
