...
war_through_age %>%
  ...
  geom_hline(yintercept = 16.75, lty = "dashed") +
  ggtitle(glue("Probability of HOF election"), subtitle = "Active or retired but not voted on yet. 16.75% = Predicted Hall of Famer")
