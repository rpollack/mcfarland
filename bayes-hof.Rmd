...
geom_hline(yintercept = 50, color = "red", lty = "dashed") +
geom_hline(yintercept = 75, color = "orange", lty = "dashed") +
  geom_hline(yintercept = 95, color = "green", lty = "dashed") +  ggtitle(glue("Probability of HOF election"), subtitle = "Players already considered for the HOF, may be inducted as manager")
```
