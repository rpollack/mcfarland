...
```{r}
# TODO: check what happens when player appears in two ASG's per year. Rocky Colavito, Yogi Berra, Frank Malzone all appeared in both 1959 games.  https://baseballhall.org/discover/Play-It-Again-The-Two-All-Star-Game-Era. Luis Aparicio had 2 in 1962
# TODO: spot-check data.

# join ASG data while accounting for the 2 ASG's per year from 1959-1962
bat_data |>
   |>
  View()
...
bat_data_full <-
  ...
  distinct(PlayerId, Name, age, WAR, H, HR, SB, off, def, max_cume_frnch_g, career_midpoint_year, mlb_played_last, num_mvps, num_asg) |>
...
hof_split <-
  ...
  dplyr::select(age, max_cume_frnch_g, career_midpoint_year, cumulative_war, scandal_type, cumulative_mvps, cumulative_hr, cumulative_h, cumulative_sb, cumulative_asg, hof) |>
