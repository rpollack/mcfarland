...
player_predictions <-
  ...
  select(Name, age, pred_hof, prob_hof, cumulative_war, war_per_year, cumulative_h, cumulative_hr, cumulative_mvps, scandal_type, career_midpoint_year, max_cume_frnch_g, cumulative_sb) |>
...
player_predictions |>
  ...
  select(Name, pred_hof, age, cumulative_war, war_per_year) |>
  arrange(desc(pred_hof), desc(war_per_year)) |>
  kbl() |>
  kable_styling()
```
