...
current_voting_data <-
  read_csv("2019 BBHOF Tracker-6/Summary-Table 1.csv")
...
ggplot() + 
  geom_histogram(binwidth = 0.1, aes(y=..density..)) +
  stat_function(fun = dbeta,
                args=list(shape1 = 41.57501, shape2 = 184.0197),
                aes(color="Scott Rolen")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 162.6463, shape2 = 62.94837),
                aes(color = "Roger Clemens")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 77.59696, shape2 = 147.9977),
                aes(color = "Fred McGriff")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 18.95226, shape2 = 206.6424),
                aes(color = "Andruw Jones")) +
  stat_function(fun = dbeta,
                args = list(shape1 = 137.5812, shape2 = 88.0135),
...
est_hof_all %>%
  mutate(`Estimated Vote Share (%)` = round(est_hof_vote_share * 100, 3)d,
