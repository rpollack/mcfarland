...
# get to-date voting information from HOF Tracker
current_voting_data <-
...
voting_info_to_date <-
  ...
  dplyr::select(Name, num_votes_received, year_on_ballot, vote_year, total_ballots, jaws)
...
# edgar martinez: prior vs. posterior
ggplot() + geom_histogram(binwidth = 0.009, aes(y=..density..)) +
  stat_function(fun = dbeta,
                args=list(shape1 = 0.8895907, shape2 = 1.417794),
                aes(color = "Prior")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 118.8896, shape2 = 12.41779),
                aes(color="Posterior")) +
  xlim(0, 1) + labs(x="HOF Vote Share") + 
  ggtitle("Edgar Martinez in 2019: Prior Expectations vs. Posterior Probabilities") +
  fgt
