...
est_hof_repeat_position_players <- 
  repeat_position %>%
  mutate(mu = mu,
         alpha0 = mu / sigma,
         beta0 = (1 - mu) / sigma,
...
ggplot() + geom_histogram(binwidth = 0.1, aes(y=..density..)) +
  stat_function(fun = dbeta,
                args=list(shape1 = 35.640424, shape2 = 8.495553),
                aes(color = "Prior")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 176.64042, shape2 = 23.49555),
                aes(color="Posterior")) +
...
ggplot() + geom_histogram(binwidth = 0.1, aes(y=..density..)) +
  stat_function(fun = dbeta,
                args=list(shape1 = 28.7401, shape2 = 15.39587),
                aes(color = "Prior")) +
  stat_function(fun = dbeta,
                args=list(shape1 = 142.7401, shape2 = 57.39587),
                aes(color="Posterior")) +
  xlim(0, 1) + labs(x="Est. HOF Vote Share") + 
...
#  NOW I NEED TO DO THE ABOVE FOR REPEAT STARTERS

# AND FUCKING REPEAT RELIEVEFRS TOO. JFC
