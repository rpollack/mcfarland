...
showalter_plt <-
  ...
  labs(x="First-Half K-BB% Relative to Other Relievers", y="Second Half Mean gmLI") +
  facet_wrap(vars(Season)) + ggtitle("First-half K-BB%+ vs. Second-Half gmLI, Relievers: Buck Showalter,Orioles", 
