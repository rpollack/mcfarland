...
single function to test getting managers from bb-ref
```{r}

url <- "https://www.baseball-reference.com/teams/BAL/index.shtml"
 ...
 tryCatch(
  ...
  filter(!str_detect(Manager, "and")) %>%               # remove years with more than one manager
  mutate(Manager = str_extract(Manager, "[A-Z].[:graph:]*"))
    error = function(e) {
