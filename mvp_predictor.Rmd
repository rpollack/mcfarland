...
evaluate model using "most likely MVP season" as "predicted MVP"
```{r}
...
# AUC = 0.8223 This is the probability that a random positive example will be ranked above a random negative example.
# F1: 0.619
```
...
mvp_predictions %>%
  ...
  ggtitle(sprintf("Top 10 %s Player-Seasons with the Highest MVP Probabilities", year_to_predict))
