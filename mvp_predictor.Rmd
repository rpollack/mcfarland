...
# TODO: Find the is_mvp/not_mvp cutoff that maximizes the F1 score
...
# AUC = 0.749 This is the probability that a random positive example will be ranked above a random negative example.
# F1: 0.645
```
