...
ggplot() + geom_histogram(binwidth = 0.009, aes(y=..density..)) +
  stat_function(fun = dbeta,
                args=list(shape1 = 48.52588, shape2 = 15.51216),
                lwd=1.5,
                aes(color="Prior Expectations")) +
   stat_function(fun = dbeta,
                args=list(shape1 = 93.52588, shape2 = 21.51216),
                lwd=1.5,
                aes(color="Posterior")) +
  xlim(0.55, 0.95) + labs(x="Estimated SB Success Rate") + 
  ggtitle("Tim Raines, 1992") + 
