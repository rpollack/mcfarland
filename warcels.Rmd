...
# would you believe there are TWO josh donaldsons in here?
...
all_arb <- bind_rows(arb_2015, arb_2016, arb_2014) %>%
  filter(SrvTm >= 2,
         SrvTm <= 3.9,              #make sure to catch first-year arbs only
         Name != "Eric Young") %>%  #EY messes this up b/c his father is in there
  select(-SrvTm)
