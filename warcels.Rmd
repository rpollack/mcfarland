...
control_information <- all_teams_payroll %>%
  ...
  mutate(super_two = ifelse(Name %in% c(
           ...
           "Addison Russell", "Cam Bedrosian", "Carlos Rodon", "Corey Knebel", "Felipe Rivero", "Hunter Strickland", "Kris Bryant", "Maikel Franco",
           "Michael Lorenzen", "Mike Foltynewicz", "Odrisamer Despaigne", "Austin Hedges", "Carlos Estevez", "Dario Alvarez", "Elias Diaz",
           "Jose Ramirez", "Justin Nicolino", "Mac Williamson", "Matt Boyd", "Michael Fulmer", "Nick Goody", "Tim Adleman", "Tyler Naquin" 
           ), 
           TRUE, FALSE)) %>%
  ...
  summarize(years_of_control = ifelse(n() > 5, 5, n()),
            ...
            #For each player, the maximum value of the years_before_first_arb column is how long until they hit Arb-1.
