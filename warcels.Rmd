...
projected_war <- all_players %>%
  ...
  #project war for each of the next 5 years, using tango's method: http://tangotiger.com/index.php/site/article/war-marcels-...-warcels
...
warcels <- master %>%
  ...
  filter(Year == max(Year),
         ...
         #retain only non-scrub players
         (war_under_control > 1 | aav > 5)) %>%
...
#ggplot(fa_warcels, aes(millions_per_win)) + geom_histogram(binwidth = 10)
