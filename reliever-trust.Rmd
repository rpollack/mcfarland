...
reliever_trust_changes <- gmli %>%
  ...
  select(PlayerId, Name, from_year, to_year, proj_age, gmli_diff, ValueW, actual_war_after_trust_change, proj_war_after_trust_change,
...
My last article [http://www.hardballtimes.com/relievers-who-gained-or-lost-the-most-trust-in-a-single-year/] explored the relievers who gained or lost the most trust in a single offseason since 1974. It was a fun list to compile, and I learned some interesting stories abouy guys like Mike Timlin and Donne Wall. And as always, the comments and Twitter generated some interesting discussions and provided avenues for future research.

One of those avenues of research is the question we should all be asking ourselves when we read articles like these: "so what?" Talking about relievers losing or gaining trust can be fun and interesting from a historical perspective. Sometimes that's enough. Other times, we want to dig deeper. To that effect, one specific Internet citizen suggested some future research to me:
...
The question is a fine one. Answering it will help us understand what, if any, effect a demotion or promotion has on actual relief performance. Given today's focus on relief pitcher roles, which despite Andrew Miller's 2016 posteason are still the norm on baseball diamonds nationwide, knowing this information could guide bullpen construction. Plus, the question is just plain interesting. So I decided to attempt an answer. 


METHODOLOGY

For this study I used the same Year 1 and Year 2 gmLI measurements and data as I did in my last article. I also added in my interpretation of "did the reliever respond any differently than he would have otherwise?" A subsequent tweet by Tango proposes to measure "differently" in the year following the gmLI change, or Year 3. Mathematically I translated this to Year 3 Actual WAR - Year 3 Projected WAR.
...
I set the threshold at 150 batters faced for three straight seasons because I wanted to include as many relievers as possible while ignoring flukes. As with many studies, selection bias rears its head here. The study includes only relievers who were good enough to be sent to a major-league mound three years in a row. But it's the data we have. Lowering the threshold any further opens us up to fluke changes in gmLI or partial seasons, and I'm not equipped to incorporate those yet.

EXAMPLES

You'll recall from my last article that Mike Timlin's gmLI increased by 1.40 from 1994 to 1995. He didn't change teams or managers; he just pitched better, earning a more important role on the team. The question I answered was: how well did Timlin pitch in 1996, the year following his "promotion", vs. his 1996 projection, which is what we'd otherwise expect of him?

Tango's WARcels method projected Timlin for 0.38 WAR in 1996. This projection seems quite low until you glance at the WAR values it's using. From 1993 - 1995 Timlin recorded WARs of 0.2, 0.2, and 1.3. He also debuted at age 25, making 1996 his age-30 season. So any reasonable manager, let alone an algorithm, would have reason to doubt he could maintain his 1995 breakout into 1996.

But maintain it he did: in 1996 Timlin recorded 1.42 WAR. So after seeing a Year 1 to Year 2 increase of 1.4 gmLI, he overperformed his Year 3 projections by 1.04 WAR. In the scatter plot you'll see below, I'll place a point at (1.4, 1.04).

Another example: from 2013 to 2014, Pat Neshek moved from the Athletics to the Cardinals and gained 1.15 gmLI along the way. After a solid year his projected WAR for Year 3, his 2015 season with the Astros, was 0.42. He instead compiled only 0.21 WAR. So we add another data point, but this time at (1.15, -0.21).
...
A scatterplot of all available data points looks like this:
...
The line of best fit shows a miniscule (r = -0.04) relationship between the gmLI change from Year 1 to Year 2 and WAR overperformance in Year 3. The tiny relationship that's there is negative; that is, relievers who gained trust in Year 2 of a three-year stretch overperformed their Year 3 WAR by less than those who lost trust in Year 2.

To the extent that this effect is worth worrying about, I presume it's because ...

I also bucketed the reliever season-pairs into 10 groups and calculated the mean WAR overperformance in each group. Group 1 lost the largest amount of gmLI in year 2, whereas Group 10 gained the most. The following chart shows that in Year 3, all deciles experienced a similar overperformance relative to their projections:
