...
fa_signings_clean %>%
  ...
  mutate(label = ifelse(offseason %in% c(2018, 1999, 2017, 2004, 2003, 1998, 1989, 1994, 1990, 1991, 1993) & 
...
cumulative_sign_plt <- 
  ...
  summarize(num_signings = n()) %>%
  group_by(offseason) %>%
  mutate(label = ifelse(offseason %in% c(1985, 2018, 2017, 2003) & 
                          sign_month == max(sign_month), 
                        offseason, NA_character_)) %>%
  arrange(offseason, sign_month) %>%
