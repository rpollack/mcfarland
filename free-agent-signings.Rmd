...
# TODO: add in international FA signings. looks like bb-ref doesn't track these. we'll do this by getting the team info from MLBTR and joining the datasets

# MLBTR also gets extensions. this pollutes the dataset a bit. but if we can mark extensions as such, we can filter them in/out as needed? it doens't look like they're classified as such in the dataset though.

# is there a way to get all int'l free agent signings?
