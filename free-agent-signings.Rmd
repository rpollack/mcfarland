...
intl_fa <-
  ...
  bind_rows(tibble(
    name = c("Yasmany Tomas", "Kenta Maeda", "Eric Thames", "Miles Mikolas"),
             `To Team`= c("ARI", "LAD", "MIL", "STL"),
             sign_salary = c(68.5, 25, 16, 15.5),
             offseason = c(2014, 2015, 2016, 2017))) %>%
...
fa_signing_plt <-
  ...
  ggtitle("Free Agent Spending, 2009–2019") +
