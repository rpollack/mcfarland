...
get_international_signings <- function(year) {
  ...
  read_html(glue("https://www.spotrac.com/mlb/international/{year}")) %>%
    ...
    mutate(offseason = year - 1)  #correct for the way spotrac reports its years relative to bb-ref
}
...
# get international signings from spotrac. baseball-reference doesn't list these and MLBTR mixes them in with extensions
intl_fa <-
  seq(2011, 2020) %>%
...
# signed during the 2019 offseason. fucking data irregularities.
