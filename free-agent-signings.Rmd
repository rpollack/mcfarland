...
fa_signings <- 
  ...
  ungroup() %>%
  dplyr::select(name = Name, offseason, age = Age, sign_date = Date, three_year_war = `WAR3`, AB, G = `G...10`, GS, IP) %>%
...
all_free_agents <-
  ...
  distinct(name, offseason, age, sign_date, three_year_war, sign_type, sign_month, AB, GS, G, IP) %>% # remove duplicate entries; many years have them
...
all_free_agents %>%
  ...
  ggtitle("Offseason vs. Median Time to Sign Contract",
    subtitle = "Free Agents through January 25, 2020"
  ) + 
