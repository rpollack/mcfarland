...
money_differences %>%
  ...
  #                            (position == "Relief Pitcher" & player_type == "Superstar" & age_bucket == "31 and 33") |
  #                            (position == "Position Player" & player_type == "Role Player" & age_bucket == "33+") |
  #                            (position == "Starting Pitcher" & player_type == "Solid Starter" & age_bucket == "Between 28 and 30")
  #                          ~ glue("{position}, {player_type}, {age_bucket}"),
  #                          TRUE ~ NA_character_)
  #        ) %>%
 ...
 theme(legend.position = "none") +
  ...
  labs(x="Difference in Mean Days to Sign", y="Difference in Median $ Signed For ")
...
money_differences %>% 
  ...
  fgt + labs(x="", y="Difference in Average Days Elapsed Before Signing FA Contract, 2018 vs. 2017") +
  ggtitle("The Hot Stove Thawed a Bit in 2018")
