...
intl_fa <-
  ...
  bind_rows(tibble(
    name = c("Yasmany Tomas", "Kenta Maeda", "Eric Thames", "Miles Mikolas", "Byung-ho Park"),
             `To Team`= c("ARI", "LAD", "MIL", "STL", "MIN"),
             sign_salary = c(68.5, 25, 16, 15.5, 12.85),
             offseason = c(2014, 2015, 2016, 2017, 2015))) %>%
...
fa_signing_plt <-
  ...
  ggtitle("Free Agent Spending, 2010–2019 Offseasons") +
  labs(x = "", y = "FA Contracts Signed (USD Million)") +
