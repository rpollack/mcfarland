...
cumulative_spend_plt <-
  all_free_agents %>%
  filter(sign_type %in% c("Domestic Free Agent", "Contract Extension"),
         !is.na(to_team),
         to_team != "") %>%
  ...
  ggplot(aes(`Domestic Free Agent`, `Contract Extension`, color = to_team)) +
...
ggplotly(cumulative_spend_plt, tooltip=c("to_team", "Domestic Free Agent", "Contract Extension"))
```
