...
warcels <- 
  ...
  summarize(
    ...
    surplue_value_under_control = (millions_per_war * war_under_control) - salary_under_control,
...
warcels %>%
  ...
  ggplot(aes(reorder(Team, total_surplue_value_under_control), total_surplue_value_under_control)) + geom_col() + coord_flip() +
  fgt
```
