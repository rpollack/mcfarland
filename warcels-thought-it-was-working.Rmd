...
# TODO: Arb salaries seem high. wade leblanc is crazy high
...
#retain players with less than 0 WAR under control or whose AAV is over $5 mil.
...
warcels <- 
  ...
  summarize(
    ...
    surplus_value_under_control = sum(surplus_value),
...
warcels_team_2018 %>%
  ggplot(aes(reorder(Team, total_surplus_value_under_control), total_surplus_value_under_control)) + geom_col() + coord_flip() +
  fgt
...
team_war_per_season %>%
  ...
  labs(y="Surplus Value Under Control")
...
player_surplus_value_changes %>%
  ...
  labs(x="", y="Surplus Value Change (USD Millions)") + ggtitle("Largest Increases in Controlled Surplus Value\n2017-2021 Period to 2018-2022 Period")

#largest surplus value decreases
player_surplus_value_changes %>%
  tail(25) %>%
  ggplot(aes(reorder(Name, surplus_value_change), surplus_value_change)) + geom_col() + coord_flip() + fgt +
  labs(x="", y="Surplus Value Change (USD Millions)") + ggtitle("Largest Decreases in Controlled Surplus Value\n2017-2021 Period to 2018-2022 Period")
