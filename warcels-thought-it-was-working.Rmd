...
# TODO: guys like lance mccullers have no FA year listed so we don't know which arb years they're in. 
## find them with this code: > master_list %>% filter(is.na(salary))
# TODO: running the code below gives me an error. something about not being able to convert the 'salary' col to numeric.
#  could be because there are NA's in the column? related to the previous issue?
