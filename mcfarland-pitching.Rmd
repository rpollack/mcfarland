...
pitching_stats_current <-
  ...
  clean_names() |>
  mutate(
    name = str_remove_all(name, "<[^>]+>") # remove anything that looks like <…>
  ) |>
...
“Write in the style of a thoughtful baseball analyst on a sports radio show — explain trends with examples, transitions, and context.”
