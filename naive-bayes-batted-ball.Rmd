...
savant_data_full <-
  ...
  dplyr::select(
    ...
    batter_stands, sprint_speed, park, defending_team, inning_top_bottom, game_date, game_month, game_year, pitcher, hc_x, hc_y, launch_speed, launch_angle, spray_angle, events
  )
```
...
savant_data <-
  savant_data_full %>%
  dplyr::select(game_year, game_month, launch_speed, launch_angle, spray_angle, sprint_speed, batter_stands, park, defending_team, events) 
