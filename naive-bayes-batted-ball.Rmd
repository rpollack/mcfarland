...
savant_data_rf <- fg_db %>%
  ...
  select(game_year,              # many baseball factors fluctuate year-to-year
...
using above model, predict full dataset so we can see which plays went from HR to out or whatever
...
#predict events using model data
