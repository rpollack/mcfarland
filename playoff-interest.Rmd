...
tweet <- glue("The MLB playoffs start in {difftime(playoff_start, Sys.Date(), units = 'days') %>% floor() %>% as.numeric()} days.

The playoff picture right now is attached.

Today's most impactful game: {away_handle} ({away_pct}% chance) at {home_handle} ({home_pct}% chance).
