...
poff_chances <-
  ...
  mutate(
    avg_poff_chance = round((poff_chance_538 + poff_chance_bbref + poff_chance_davenport + poff_chance_fg + poff_chance_numberfire + poff_chance_teamrankings) / 6, 0),
...
poff_chances %>%
  pivot_longer(2:7, names_to = "site") %>%
