...
train_model(batter_hof_train, "gbm")
...
batter_model_evaluation <-
  ...
  mutate(predict_xgbTree = as.numeric(predict(hof_voting_model_xgbTree, newdata =.)),
         predict_linear = as.numeric(predict(hof_voting_model_lm, newdata =.)),
         predict_svmRadial = as.numeric(predict(hof_voting_model_svmRadial, newdata = .)),
         ...
         predict_gbm = as.numeric(predict(hof_voting_model_gbm, newdata = .))) %>%
