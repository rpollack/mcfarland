...
set_narrative <- function(name) {
  ...
  case_when(
    ...
    name %in% c("Jim Rice", "Andre Dawson", "Jack Morris", "Bruce Sutter", "Jorge Posada", "Omar Vizquel") ~ 0.5,
    
    #strong positive narrative; something about their career and/or character strongly transcends their stats
    name %in% c("Tom Glavine", "Roy Halladay", "Mariano Rivera", "Trevor Hoffman", "Kirby Puckett", "Bill Mazeroski") ~ 1,
...
starter_data_pre <-
  starter_hof_data %>%
  dplyr::select(-vote_share, -narrative_score, -year_on_ballot, -vote_year)
