...
# starting pitcher r^2 is 0.80. quite a shock you can get that high with so little information. but the diff in R^2 shows there is value
...
first_year_starting_pitchers <-
  ...
  dplyr::select(vote_year, ERA, SO, W, IP, num_no_hitters_and_perfect_games, narrative_score, bj_hof_monitor, vote_share)
