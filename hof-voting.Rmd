...
TODO: the 'position' mutation below doesn't account for designated hitters (Martinez).
...
#train_model(batter_hof_train, "gbm", control_parameters)
...
ggplot(model_metrics, aes(`zR^2`, zRMSE)) + geom_point() + fgt +
  ...
  xlim(-3, 3) + ylim(-3, 3) + 
  geom_label(aes(label=str_c(str_replace(`Model Type`, "predict_", ""), ": R^2 = ", round(`R^2`, 1), ", RMSE = ", round(RMSE, 1)))) +
