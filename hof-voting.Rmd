...
set_narrative <- function(name) {
  ...
  case_when(
    ...
    # strong negative narrative: PED connection or suspension of some kind
    name %in% c(
    "Barry Bonds", "Roger Clemens", "Alex Rodriguez",
    "Gary Sheffield", "Rafael Palmeiro", "Sammy Sosa", "Mark McGwire", "Manny Ramirez", "Pete Rose",
    "Jose Canseco", "Ken Caminiti", "Miguel Tejada", "Robinson Cano", "Ryan Braun", "Marlon Byrd", "Nelson Cruz") ~ -1,
...
predict(position_player_hof_voting_model_xgbLinear, newdata = batter_voting_future_preprocessed) %>%
  as_tibble() %>%
