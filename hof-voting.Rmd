...
batter_train_matrix <- 
  ...
  select(-vote_share) %>% 
  as.matrix()
batter_dtrain <- xgb.DMatrix(data = batter_train_matrix,
...
batter_hof_xgb_mdl_params <- xgb.cv(params = params,
                               data = batter_dtrain,
                               nrounds = 500,
                               nfold = 100,
...
batter_hof_xgb_mdl <- xgb.train(params = params,
                                data = batter_dtrain,
                                nrounds = num_rounds)
...
batter_dtest <- xgb.DMatrix(data = batter_test_matrix,
...
do a regular round of xgb tree-ing ... 
