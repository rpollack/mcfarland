...
Position Players: extract data from main dataset and pre-processs
...
xgb_rmse <- round(RMSE(xgb_predictions$predicted_vote_share, xgb_predictions$vote_share), 1)

xgb_r_squared <- round(summary(lm(xgb_predictions$predicted_vote_share ~ xgb_predictions$vote_share))$r.squared, 2)
