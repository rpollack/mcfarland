...
The xgboost model explains 96% of the variance in the actual second-half K rates.
...
The residuals have some skew but not an unreasonable amount. The RMSE of the predictions is 0.015, or 1.5 percentage points of second-half strikeout rate, which strikes me as low.
...
The front office wants to know which pitchers to target in mid-season trade talks. 



The final code chunk creates a CSV file of predicted and actual second-half K rates for each pitcher. For brevity's sake the results are not included in this file.
