...
results <- pitchers_2017_predicted %>%
  ...
  mutate(residual = predicted_second_half_k_rate - actual_second_half_k_rate)
...
lm_fit <- lm(results$actual_second_half_k_rate ~ results$predicted_second_half_k_rate)
r_squared <- > summary(lm_fit)$r.squared

# TODO: calculate & show R^2 of actual ~ pred
...
# plot fitted vs. residuals to show bias
# TODO: Put on common scale
results %>%
  ggplot(aes(predicted_second_half_k_rate, residual)) + geom_point()
