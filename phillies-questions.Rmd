...
Two lines are shown. The dashed reference line shows a hypothetical perfect match between all predictions and actual results. The blue best-fit line shows the actual match between the model's predictions and actual results.
