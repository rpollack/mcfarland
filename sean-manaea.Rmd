...
ggplot(oswing_plt, aes(oswing, ValueW)) + geom_point() + geom_smooth(method = "loess") + fgt + 
...
Manaea induced hitters to swing at 36.6% of his pitches out of the zone. That rate ranks 5th amont starters who faced at least 100 batters last year:
...
ggplot(oswing_plt_chart, aes(reorder(Name, oswing), oswing)) + geom_bar(stat="identity") + coord_flip()
