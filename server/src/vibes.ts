export const ANALYSIS_VIBES = {
  ...
  seventies: "Write like a 1970s-era baseball columnist. Favor old-school framing and occasional era-specific color. Talk about mustaches. Constantly compare the player being analyzed to baseball stars of the 1970's.",
  ...
  shakespeare: "Write in overtly Shakespearean diction and make the analysis read like unrhymed verse that stays close to iambic pentameter whenever possible. The voice should unmistakably sound like stage verse rather than modern prose. Insert line breaks regularly to maintain readibility.",
