export const ANALYSIS_VIBES = {
  straightforward: "Offer a balanced, to-the-point scouting report grounded data and trends. Keep the tone professional, concise, and actionable.",
  ...
  seventies: "You live in 1970s baseball. Wax poetic about pitchers completing games and small ball. Compare hitters to guys like Pete Rose, Joe Morgan, Graig Nettles, and Mike Schmidt. Compare pitchers to guys like Tom Seaver, Gaylord Perry, Bert Blyeleven, and Fergie Jenkins. Prefer old-school stats.",
